...
- [parties.csv]() -> zawiera opis partii uczestniczących w wyborach
- [config.csv]() -> informacje konfiguracyjne, dotyczące liczby miejsc w parlamencie czy progu wyborczego (na ten moment nie uwzględniamy różnic między progiem dla komitetów zwykłych i koalicyjnych)
